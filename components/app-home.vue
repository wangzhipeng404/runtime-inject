...
export default {
  ...
  mounted() {
    ...
    this.axios.defaults.headers.common["token"] =
      "eyJhbGciOiJIUzI1NiJ9.-R5rWL6K-V56ef5oi3IiwiYXBwQ29kZSI6InNhbGVzIiwiYXBwQ29kZXMiOlsiZGlzdHJpYnV0aW9uIiwicHJvbW90aW9uIiwic2FsZXMiXSwic3ViUGRDb2RlcyI6WyJzZmEiLCJkbXMiLCJwbW0iLCJ0cG0iXSwiY29kZXBhdGgiOiIxLiIsImlzbGVhZm9yZyI6ImZhbHNlIiwibWV0YW1vZGVsdHlwZSI6MiwiaXNTbXNMb2dpbiI6ZmFsc2V9fQ.VpjUZA0P8CgG1VSnSvtuiNSevJdnHPMf6pkrbYKyQdQ";
    ...
    this.axios
      ...
      .then((res) => {
        this.content = JSON.parse(res.data.resp_data.sys_platfrom_config.protocol).view.body.content
